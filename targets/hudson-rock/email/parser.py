# targets/hudson-rock/email/parser.py
"""
Hudson Rock Email Search API Response Parser
"""
...
class HudsonRockEmailParser:
    """Parser for Hudson Rock email search API responses"""
